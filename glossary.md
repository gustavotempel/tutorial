...
**DTO:** Data Transfer Object (Patrón de diseño de Objeto de Transferencia de Datos).
...
**JDK:** Java Development Kit (Kit de Desarrollo Java). Contains JRE, compiler (javac.exe), API.
